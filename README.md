...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/arbol-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15409&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/arbol-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `arbol` can be installed with:

```
conda install arbol
```

It is possible to list all of the versions of `arbol` available on your platform with:
